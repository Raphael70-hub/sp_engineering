...
const ProductReviews = ({ product, avgRating }) => {
            ...
            {product.reviews.length > 5 && (
                <div  className="flex justify-end">
                    <button
                        ...
                        className="mt-4 px-6 py-2 text-orange-600 bg-transparent rounded-lg cursor-pointer"
                    >
                        <span>See All</span>
                        <ArrowRightIcon className="ml-2 h-5 w-5 text-current inline-flex" />
